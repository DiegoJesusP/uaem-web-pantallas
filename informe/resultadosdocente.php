...
<body style="background-color: #F6F6F6;">
    ...
    <div class="container textB">
        ...
        <div class="col-12 d-flex justify-content-end">
            <a href="./../docs/manual_descarga_reporte_ind.pdf" target="_blank" style="color: red; margin-bottom: 10px;">Instructivo<img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/uaem-web-pantallas/assets/img/libro.png" alt="ubicacion" class="img-fluid icon alin" style="width: 47px; height: 50px;"></a>
        </div>
        <?php
        $numcontrol = '';
        $periodo = '';
        ...
        <div style="margin-bottom: 20px;" class="row align-items-center">
            ...
            <div class="col-12 col-md-4 d-flex justify-content-end d-none d-md-flex">
                <button class="button" onclick="location.href='http://<?php echo $_SERVER['HTTP_HOST']; ?>/uaem-web-pantallas/informe/docente.php';">
